...
final class BroadcastHappRoutingCommand extends Command
{
    private const string MESSAGE = <<<TEXT
        ...
        <b>Как включить:</b>
        Нажмите на ссылку ниже — Happ откроется и применит настройки автоматически. В приложении появится оповещение -
        загрузка гео-файлов". Дождитесь, пока оно пропадет и перезапустите подключение.

        После этого попробуйте зайти на сайта Ozon или Kinopoisk, например. Если что-то не получилось - пишите мне @moildar
