...
final class HasActiveSubscriptionQueryHandlerTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->registerUserHandler = new RegisterUserCommandHandler($this->userRepository);
    ...
    public function testReturnsTrueWhenActiveSubscription(): void
    {
        // Arrange
        ($this->registerUserHandler)(new RegisterUserCommand(111222333));
        $user = $this->userRepository->findByTelegramId(new \App\User\Domain\ValueObject\TelegramId(111222333));
    ...
    public function testReturnsFalseWhenExpiredSubscription(): void
    {
        // Arrange
        ($this->registerUserHandler)(new RegisterUserCommand(111222333));
        $user = $this->userRepository->findByTelegramId(new \App\User\Domain\ValueObject\TelegramId(111222333));
